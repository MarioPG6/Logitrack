        ...
        >
          ...
          <div>
            ...
            <p class="text-lg text-emerald-50 mb-8">
              Manage your logistics from a single platform.
            </p>
          </div>
      ...
      <div class="w-full md:w-1/2 p-8 lg:p-16 flex items-center">
        <div class="max-w-md mx-auto w-full">
          ...
          <div class="text-center mb-10">
            ...
            <p class="text-slate-500">Fill in your details</p>
          </div>
          ...
          <form @submit.prevent="handleRegister" class="space-y-6">
            ...
            <!-- MENSAJE -->
            <p v-if="message" class="text-center text-sm text-red-600">
              {{ message }}
            </p>
...
<style scoped>
.input {
  @apply w-full py-3 bg-slate-50 dark:bg-slate-900 border rounded-lg
  focus:ring-2 focus:ring-primary outline-none dark:text-white;
}
